<sam-limits-monitoring-period-dialog>
		...
		<guf-linear-layout ref="vertical-wrapper" orientation="vertical" v-align="center" class="vertical-wrapper">
			<guf-linear-layout ref="dialog" orientation="vertical" class="dialog">
				<guf-linear-layout ref="header" orientation="horizontal" v-align="center" class="header">
					<div class="dialog-title">{guf.i18n.get('app.period')}</div>
					<div class="flex1"></div>
					<guf-button ref="close-button" type="icon" icon="close" dcss-text-color="@lighttext"></guf-button>
				</guf-linear-layout>
				<guf-linear-layout ref="content" orientation="vertical" h-align="center" class="content">
					<div class="period">{guf.ancestor(this, 'sam-limits-monitoring-period-dialog').periodText}</div>
				</guf-linear-layout>
			</guf-linear-layout>
		</guf-linear-layout>
	</guf-linear-layout>
	...
	<script type="text/javascript">
		...
		tag.periodText = guf.param.string(opts.periodText, "");
