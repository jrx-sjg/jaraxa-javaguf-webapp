<sam-reporting-content>
	<div class="flex1"></div>
	<guf-button id="reporting-excel-button" ref="excel-button" type="icon" color="true" icon="table_chart" icon-outlined="true" dcss-text-color="@primary" dcss-text-color-disabled="@lines"></guf-button>
	<div class="mdl-tooltip mdl-tooltip--large" for="reporting-excel-button">{guf.i18n.get('app.export_excel')}</div>
