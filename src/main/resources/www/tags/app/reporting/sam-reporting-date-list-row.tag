<sam-reporting-date-list-row>
	<guf-linear-layout ref="main-level" orientation="horizontal">
		...
		<div class="id-column flex1" ref="student-data">{guf.ancestor(this, 'sam-reporting-date-list-row').studentId}</div>
		<div class="total-column">{guf.ancestor(this, 'sam-reporting-date-list-row').total}</div>
		<div class="tail-column"></div>
	</guf-linear-layout>
	<div if="{guf.ancestor(this, 'sam-reporting-date-list-row').expanded}" class="nested-container">
		<sam-reporting-date-list-row-nested each={item in guf.ancestor(this, 'sam-reporting-date-list-row').item.absencesDetail}></sam-reporting-date-list-row-nested>
	</div>
